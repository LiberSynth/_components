...
begin
  ...
  with _Parser do begin
    ...
    { TODO 5 -oVasilyevSM -cTCustomStringParser: „е за костыли? ѕочему еще не подвинуто? }
...
begin
  (_Parser as TParamsStringParser).ElementType := etValue; { TODO 1 -oVasilyevSM -cGeneral: ќн и так value здесь }
  inherited Closed(_Parser);
end;
