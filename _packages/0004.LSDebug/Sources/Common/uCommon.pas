...
{ TODO 1 -oVasilyevSM -cuLSDebug: Надо настроить билд-ивент, копировать все компилируемые бплки в общий каталог. И
  записать это на самом видном месте: ДТ-пакет при загрузке среды читает ДТ-пакеты с зарегистрированными компонентами
  своего рикуайрз из этого общего каталога и все. }
